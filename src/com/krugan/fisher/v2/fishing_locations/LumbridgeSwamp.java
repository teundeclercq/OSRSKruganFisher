...
import com.krugan.fisher.v2.fish.ShrimpAnchovies;
...
public class LumbridgeSwamp extends KFishingLocation {
    protected  AbstractFish[] abstractFish;

    public LumbridgeSwamp() {
    ...
    public Area fishingArea() {
        return new Area(3249, 3148, 3240, 3160);
    }
